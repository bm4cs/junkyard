...
% Packages to install:
% * texlive-extra-utils (latex-indent formatter)
...
\section{Setup}
\begin{tabular}{}
\verb!config core.autocrlf input! & Set to \texttt{true} on Windows \\
\verb!config core.safecrlf true !  & Check conversion is reversible \\
\end{tabular}
...
\texttt{git log --oneline --graph --decorate} & Visual history graph \\
\texttt{letterpaper} & Paper size. \\
