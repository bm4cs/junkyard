package net.bencode.web;

import net.bencode.ejb.MyStatefulBeanLocal;
import net.bencode.ejb.MyStatelessBeanLocal;
...
public class TestServlet extends HttpServlet {
    ...
    @Inject
    MyStatefulBeanLocal stateful;

    @Inject
    MyStatelessBeanLocal stateless;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.printf("<code>%s</code>", webmaster);
            out.println("</body>");
            out.println("</html>");
        }
    }
